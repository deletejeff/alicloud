 ...
 * @author machao
 */
@RocketMQTransactionListener(txProducerGroup = "my-stream-add-points-group")
public class MyAddPointsMqTransactionListener implements RocketMQLocalTransactionListener {
    public static final Logger logger = LoggerFactory.getLogger(MyAddPointsMqTransactionListener.class);
    @Autowired
